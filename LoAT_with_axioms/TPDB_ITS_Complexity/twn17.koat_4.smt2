...
(assert (let ((a!1 (+ (+ 0 (+ (* it175 (- 3)) it182)) (* (iexp it176 3) (+ 0 2)))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* it176 (- 1)) it183) 0))
(assert (= (+ it184 (* it177 (- 1))) 0))
(assert (let ((a!1 (* (* (iexp 9 (+ it66 (- 1))) (iexp it183 3)) (+ 0 (- 3))))
      (a!2 (* (iexp (iexp 4 (+ it66 (- 1))) (+ 0 2)) (iexp it181 2)))
      (a!3 (* (* (iexp 9 (+ it66 (- 1))) (+ 0 it182)) (+ 0 3)))
      (a!5 (* (* (iexp 9 (+ it66 (- 1))) (iexp it183 3)) (+ 0 (- 1))))
      (a!7 (> (+ (+ 0 it182)
                 (* (iexp it181 2) (+ 0 (- 1)))
                 (* (iexp it183 5) (+ 0 (- 1))))
              (+ 0 0))))
