...
(assert (let ((a!1 (* (* (iexp 9 (+ it140 (- 1))) (iexp it377 3)) (+ 0 (- 1))))
      (a!2 (* (iexp it375 2) (iexp (iexp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!4 (> (+ (+ 0 it376)
                 (* (iexp it375 2) (+ 0 (- 1)))
                 (* (iexp it377 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (iexp 9 (+ it140 (- 1))) (iexp it377 3)) (+ 0 (- 3))))
      (a!6 (* (* (iexp 9 (+ it140 (- 1))) (+ 0 it376)) (+ 0 3))))
(let ((a!3 (+ (iexp it377 3)
              a!1
              (* (iexp 9 (+ it140 (- 1))) (+ 0 it376))
              (* a!2 (+ 0 (- 1)))
              (* (iexp it377 5) (+ 0 (- 1)))))
      (a!7 (> (+ (iexp it377 3)
                 a!5
