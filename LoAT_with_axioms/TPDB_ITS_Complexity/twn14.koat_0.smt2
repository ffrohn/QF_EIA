...
(assert (= (+ it85 (* it6 (- 1))) 0))
(assert (= (+ it86 (* it7 (- 1))) 0))
(assert (let ((a!1 (> (+ (* (iexp it85 5) (+ 0 (- 1)))
                 (+ 0 it84)
                 (* (iexp it83 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (iexp (iexp 4 (+ it109 (- 1))) (+ 0 2)) (iexp it83 2)))
      (a!3 (* (* (iexp 9 (+ it109 (- 1))) (iexp it85 3)) (+ 0 (- 1))))
      (a!5 (* (* (+ 0 it84) (iexp 9 (+ it109 (- 1)))) (+ 0 3)))
      (a!6 (* (* (iexp 9 (+ it109 (- 1))) (iexp it85 3)) (+ 0 (- 3)))))
(let ((a!4 (+ (* (+ 0 it84) (iexp 9 (+ it109 (- 1))))
              (* (iexp it85 5) (+ 0 (- 1)))
              (* a!2 (+ 0 (- 1)))
              (iexp it85 3)
              a!3))
