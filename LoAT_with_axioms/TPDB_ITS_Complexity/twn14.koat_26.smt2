...
(assert (let ((a!1 (* (* (iexp it554 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 1))))
      (a!2 (* (iexp (iexp 4 (+ it109 (- 1))) (+ 0 2)) (iexp it552 2)))
      (a!4 (> (+ (+ 0 it553)
                 (* (iexp it554 5) (+ 0 (- 1)))
                 (* (iexp it552 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (iexp it554 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 3))))
      (a!6 (* (* (+ 0 it553) (iexp 9 (+ it109 (- 1)))) (+ 0 3))))
(let ((a!3 (+ a!1
              (* (+ 0 it553) (iexp 9 (+ it109 (- 1))))
              (* (iexp it554 5) (+ 0 (- 1)))
              (iexp it554 3)
              (* a!2 (+ 0 (- 1)))))
      (a!7 (> (+ a!5
