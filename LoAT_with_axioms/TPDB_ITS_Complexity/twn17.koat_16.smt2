...
(assert (let ((a!1 (* (* (iexp 9 (+ it200 (- 1))) (+ 0 it542)) (+ 0 3)))
      (a!2 (* (* (iexp 9 (+ it200 (- 1))) (iexp it543 3)) (+ 0 (- 3))))
      (a!3 (* (iexp it541 2) (iexp (iexp 4 (+ it200 (- 1))) (+ 0 2))))
      (a!5 (* (* (iexp 9 (+ it200 (- 1))) (iexp it543 3)) (+ 0 (- 1))))
