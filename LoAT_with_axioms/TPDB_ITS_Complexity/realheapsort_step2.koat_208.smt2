...
(assert (let ((a!1 (+ (* (iexp 2 it273) (+ 0 it408) (+ 0 (- 1)))
              (+ 0 it418)
              (* (iexp 2 (+ it273 1)) (+ 0 (- 1)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
...
(assert (let ((a!1 (>= (+ (+ (* it466 (- 2)) it464 (* it465 (- 1))) (- 4)) 0))
      (a!2 (+ (* (+ 0 it466) (iexp 2 (+ it420 (- 1))) (+ 0 (- 2)))
              (+ 0 it464)
              (* (iexp 2 it420) (+ 0 (- 2)))
              (+ 0 (* it465 (- 1)))))
...
(assert (let ((a!1 (+ (* (iexp 2 (+ it420 1)) (+ 0 (- 1)))
              (* (+ 0 it466) (iexp 2 it420) (+ 0 (- 1)))
              (+ 0 it483)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (* (+ 0 it466) (iexp 2 (+ it420 (- 1))) (+ 0 (- 2)))
              (* (iexp 2 it420) (+ 0 (- 2)))
              (+ 0 it484)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
