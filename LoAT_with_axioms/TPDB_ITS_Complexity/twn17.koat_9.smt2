...
(assert (let ((a!1 (* (iexp (iexp 4 (+ it66 (- 1))) (+ 0 2)) (iexp it351 2)))
      (a!2 (* (* (iexp 9 (+ it66 (- 1))) (iexp it353 3)) (+ 0 (- 1))))
      (a!4 (> (+ (+ 0 it352)
                 (* (iexp it351 2) (+ 0 (- 1)))
                 (* (iexp it353 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (+ 0 it352) (iexp 9 (+ it66 (- 1)))) (+ 0 3)))
      (a!6 (* (* (iexp 9 (+ it66 (- 1))) (iexp it353 3)) (+ 0 (- 3)))))
(let ((a!3 (+ (* a!1 (+ 0 (- 1)))
              (iexp it353 3)
              (* (+ 0 it352) (iexp 9 (+ it66 (- 1))))
              (* (iexp it353 5) (+ 0 (- 1)))
              a!2))
      (a!7 (> (+ (* a!1 (+ 0 (- 4)))
                 (iexp it353 3)
