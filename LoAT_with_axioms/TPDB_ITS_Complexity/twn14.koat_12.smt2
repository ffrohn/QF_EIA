...
(assert (let ((a!1 (> (+ (+ 0 it361)
                 ...
                 (* (iexp it362 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (iexp it362 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 3))))
      (a!3 (* (iexp (iexp 4 (+ it109 (- 1))) (+ 0 2)) (iexp it360 2)))
      (a!4 (* (* (+ 0 it361) (iexp 9 (+ it109 (- 1)))) (+ 0 3)))
      (a!6 (* (* (iexp it362 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ (iexp it362 3)
                 a!2
                 (* a!3 (+ 0 (- 4)))
                 a!4
                 (* (iexp it362 5) (+ 0 (- 1))))
