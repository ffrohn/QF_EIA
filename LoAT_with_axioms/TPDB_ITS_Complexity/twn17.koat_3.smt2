...
(assert (let ((a!1 (* (iexp it166 2) (iexp (iexp 4 (+ it66 (- 1))) (+ 0 2))))
      (a!2 (* (* (iexp it168 3) (iexp 9 (+ it66 (- 1)))) (+ 0 (- 3))))
      (a!3 (* (* (iexp 9 (+ it66 (- 1))) (+ 0 it167)) (+ 0 3)))
      (a!5 (* (* (iexp it168 3) (iexp 9 (+ it66 (- 1)))) (+ 0 (- 1))))
      (a!7 (> (+ (* (iexp it168 5) (+ 0 (- 1)))
                 (* (iexp it166 2) (+ 0 (- 1)))
                 (+ 0 it167))
              (+ 0 0))))
(let ((a!4 (> (+ (* (iexp it168 5) (+ 0 (- 1)))
                 (* a!1 (+ 0 (- 4)))
                 a!2
                 (iexp it168 3)
                 a!3)
              (+ 0 0)))
      (a!6 (+ (* (iexp it168 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              a!5
              (iexp it168 3)
              (* (iexp 9 (+ it66 (- 1))) (+ 0 it167)))))
  (and a!4
       (> (* it166 2) 0)
       (>= (+ it163 (- 3)) 0)
       (> a!6 (+ 0 0))
