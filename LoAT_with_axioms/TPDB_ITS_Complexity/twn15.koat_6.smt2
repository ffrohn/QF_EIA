...
(assert (let ((a!1 (* (* (iexp 9 (+ it128 (- 1))) (iexp it176 3)) (+ 0 (- 1))))
      (a!2 (* (iexp (iexp 4 (+ it128 (- 1))) (+ 0 2)) (iexp it174 2)))
      (a!4 (* (* (iexp 9 (+ it128 (- 1))) (+ 0 it175)) (+ 0 3)))
      (a!5 (* (* (iexp 9 (+ it128 (- 1))) (iexp it176 3)) (+ 0 (- 3))))
      (a!7 (> (+ (+ 0 it175)
                 (* (iexp it174 2) (+ 0 (- 1)))
                 (* (iexp it176 5) (+ 0 (- 1))))
              (+ 0 0))))
(let ((a!3 (+ (* (iexp 9 (+ it128 (- 1))) (+ 0 it175))
              a!1
              (* a!2 (+ 0 (- 1)))
              (* (iexp it176 5) (+ 0 (- 1)))
              (iexp it176 3)))
