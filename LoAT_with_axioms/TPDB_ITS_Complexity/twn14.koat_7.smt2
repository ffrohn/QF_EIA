...
(assert (let ((a!1 (* (* (iexp 9 (+ it140 (- 1))) (iexp it240 3)) (+ 0 (- 3))))
      (a!2 (* (iexp it238 2) (iexp (iexp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!3 (* (* (iexp 9 (+ it140 (- 1))) (+ 0 it239)) (+ 0 3)))
      (a!5 (* (* (iexp 9 (+ it140 (- 1))) (iexp it240 3)) (+ 0 (- 1))))
