...
(assert (let ((a!1 (* (iexp (iexp 4 (+ it66 (- 1))) (+ 0 2)) (iexp it525 2)))
      (a!2 (* (* (iexp 9 (+ it66 (- 1))) (iexp it527 3)) (+ 0 (- 3))))
      (a!3 (* (* (+ 0 it526) (iexp 9 (+ it66 (- 1)))) (+ 0 3)))
      (a!5 (> (+ (* (iexp it525 2) (+ 0 (- 1)))
                 (+ 0 it526)
                 (* (iexp it527 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (* (* (iexp 9 (+ it66 (- 1))) (iexp it527 3)) (+ 0 (- 1)))))
(let ((a!4 (> (+ (* a!1 (+ 0 (- 4)))
                 a!2
                 a!3
                 (* (iexp it527 5) (+ 0 (- 1)))
