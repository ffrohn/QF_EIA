...
(assert (= (+ it48 (* it6 (- 1))) 0))
(assert (= (+ (* it7 (- 1)) it49) 0))
(assert (let ((a!1 (< (+ (+ 0 (* it47 (- 1))) (iexp it46 2) (iexp it48 5)) (+ 0 0))))
  (and (> it46 0) (= (+ it43 (- 3)) 0) a!1)))
(assert (= (+ it69 (- 3)) 0))
(assert (= (+ (* it44 (- 1)) it70 (- 1)) 0))
(assert (= (+ (* it45 (- 1)) it71) 0))
(assert (= (+ (* it46 2) it72) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it47 (- 3)) it73)) (* (iexp it48 3) (+ 0 2)))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* it48 (- 1)) it74) 0))
(assert (= (+ (* it49 (- 1)) it75) 0))
(assert (let ((a!1 (* (* (+ 0 it73) (iexp 9 (+ it66 (- 1)))) (+ 0 3)))
      (a!2 (* (iexp (iexp 4 (+ it66 (- 1))) (+ 0 2)) (iexp it72 2)))
      (a!3 (* (* (iexp 9 (+ it66 (- 1))) (iexp it74 3)) (+ 0 (- 3))))
      (a!5 (* (* (iexp 9 (+ it66 (- 1))) (iexp it74 3)) (+ 0 (- 1))))
      (a!7 (> (+ (+ 0 it73)
                 (* (iexp it72 2) (+ 0 (- 1)))
                 (* (iexp it74 5) (+ 0 (- 1))))
              (+ 0 0))))
