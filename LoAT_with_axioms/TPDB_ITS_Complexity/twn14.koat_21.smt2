...
(assert (let ((a!1 (* (* (iexp 9 (+ it140 (- 1))) (iexp it448 3)) (+ 0 (- 1))))
      (a!2 (* (iexp it446 2) (iexp (iexp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!4 (> (+ (* (iexp it448 5) (+ 0 (- 1)))
                 (+ 0 it447)
                 (* (iexp it446 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (iexp 9 (+ it140 (- 1))) (iexp it448 3)) (+ 0 (- 3))))
      (a!6 (* (* (iexp 9 (+ it140 (- 1))) (+ 0 it447)) (+ 0 3))))
(let ((a!3 (+ a!1
              (* (iexp it448 5) (+ 0 (- 1)))
              (* a!2 (+ 0 (- 1)))
              (* (iexp 9 (+ it140 (- 1))) (+ 0 it447))
              (iexp it448 3)))
      (a!7 (> (+ a!5
                 (* (iexp it448 5) (+ 0 (- 1)))
                 (* a!2 (+ 0 (- 4)))
