...
(assert (let ((a!1 (< (+ (+ 0 (* it104 (- 1))) (iexp it103 2) (iexp it105 5)) (+ 0 0))))
  (and (= (+ it100 (- 3)) 0) a!1 (< it103 0))))
(assert (= (+ it131 (- 3)) 0))
(assert (= (+ (* it101 (- 1)) it132 (- 2)) 0))
(assert (= (+ it133 (* it102 (- 1))) 0))
(assert (= (+ (* it103 2) it134) 0))
(assert (= (+ (* (iexp it105 3) (+ 0 2)) (+ 0 (* it104 (- 3))) (+ 0 it135))
   (+ 0 0)))
(assert (= (+ it136 (* it105 (- 1))) 0))
(assert (= (+ (* it106 (- 1)) it137) 0))
(assert (let ((a!1 (< (+ (iexp it136 5) (iexp it134 2) (+ 0 (* it135 (- 1)))) (+ 0 0))))
  (and (> it134 0) (= (+ it131 (- 3)) 0) a!1)))
(assert (= (+ it139 (- 3)) 0))
(assert (= (+ it140 (* it132 (- 1)) (- 2)) 0))
(assert (= (+ (* it133 (- 1)) it141) 0))
(assert (= (+ (* it134 2) it142) 0))
(assert (= (+ (+ 0 it143) (* (iexp it136 3) (+ 0 2)) (+ 0 (* it135 (- 3))))
   (+ 0 0)))
(assert (= (+ (* it136 (- 1)) it144) 0))
(assert (= (+ it145 (* it137 (- 1))) 0))
(assert (let ((a!1 (* (* (iexp 9 (+ it128 (- 1))) (iexp it144 3)) (+ 0 (- 1))))
      (a!2 (* (iexp it142 2) (iexp (iexp 4 (+ it128 (- 1))) (+ 0 2))))
      (a!4 (> (+ (+ 0 it143)
                 (* (iexp it144 5) (+ 0 (- 1)))
                 (* (iexp it142 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (iexp 9 (+ it128 (- 1))) (+ 0 it143)) (+ 0 3)))
      (a!6 (* (* (iexp 9 (+ it128 (- 1))) (iexp it144 3)) (+ 0 (- 3)))))
(let ((a!3 (+ (iexp it144 3)
              (* (iexp 9 (+ it128 (- 1))) (+ 0 it143))
              a!1
              (* (iexp it144 5) (+ 0 (- 1)))
              (* a!2 (+ 0 (- 1)))))
      (a!7 (> (+ (iexp it144 3)
