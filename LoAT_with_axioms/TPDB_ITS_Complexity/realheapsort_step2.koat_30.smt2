...
(assert (let ((a!1 (>= (+ (+ (* it174 (- 1)) (* it175 (- 2)) it173) (- 4)) 0))
      (a!2 (+ (* (iexp 2 (+ it273 (- 1))) (+ 0 it175) (+ 0 (- 2)))
              (* (iexp 2 it273) (+ 0 (- 2)))
              (+ 0 (* it174 (- 1)))
              (+ 0 it173)))
...
(assert (let ((a!1 (+ (+ 0 it280)
              (* (iexp 2 (+ it273 1)) (+ 0 (- 1)))
              (* (iexp 2 it273) (+ 0 it175) (+ 0 (- 1)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (* (iexp 2 (+ it273 (- 1))) (+ 0 it175) (+ 0 (- 2)))
              (* (iexp 2 it273) (+ 0 (- 2)))
              (+ 0 it281)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
...
(assert (let ((a!1 (* (* (iexp 2 (+ it87 (- 1))) (+ 0 it307)) (+ 0 (- 2))))
      (a!3 (* (* (iexp 2 (+ it87 (- 1))) (+ 0 it307)) (+ 0 2))))
