...
(assert (let ((a!1 (< (+ (+ 0 it277) (* (iexp it278 2) (+ 0 (- 1)))) (+ 0 0))))
...
(assert (let ((a!1 (* (iexp (iexp 2 (+ it256 (- 1))) (+ 0 2)) (iexp it286 2) (+ 0 4))))
(let ((a!2 (+ a!1
              (* (iexp 5 (+ it256 (- 1))) (iexp it287 2) (+ 0 (- 1)))
              (iexp it287 2)
              (* (iexp 5 (+ it256 (- 1))) (+ 0 it285) (+ 0 (- 4))))))
  (and (> a!2 (+ 0 0))
       (>= (+ (* it281 (- 1)) 4) 0)
       (> it285 0)
       (>= (+ it281 (- 4)) 0)
