...
(assert (let ((a!1 (> (+ (+ 0 it42)
                 ...
                 (* (iexp it43 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (iexp (iexp 4 (+ it68 (- 1))) (+ 0 2)) (iexp it41 2)))
      (a!3 (* (* (+ 0 it42) (iexp 9 (+ it68 (- 1)))) (+ 0 3)))
      (a!4 (* (* (iexp it43 3) (iexp 9 (+ it68 (- 1)))) (+ 0 (- 3))))
      (a!6 (* (* (iexp it43 3) (iexp 9 (+ it68 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ (* a!2 (+ 0 (- 4)))
                 a!3
                 (iexp it43 3)
                 (* (iexp it43 5) (+ 0 (- 1)))
