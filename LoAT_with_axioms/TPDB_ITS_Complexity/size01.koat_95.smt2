...
(assert (= (+ (+ 0 it561) (* (iexp (- 1) it447) (+ 0 it498) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (iexp (- 1) it447) (+ 0 it499) (+ 0 (- 1))) (+ 0 it562))
   (+ 0 0)))
(assert (= (+ (* (iexp it447 2) (+ 0 6))
      (* (iexp it447 3) (+ 0 (- 8)))
      (+ 0 (* it447 (- 1)))
      (* (iexp it447 2) (+ 0 it497) (+ 0 12))
      (+ 0 (* it500 (- 3)))
      (+ 0 (* it447 it497 (- 6)))
      (+ 0 (* it563 3))
      (* (+ 0 it447) (iexp it497 2) (+ 0 (- 6))))
   (+ 0 0)))
