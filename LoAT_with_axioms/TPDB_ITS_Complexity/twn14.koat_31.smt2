...
(assert (let ((a!1 (> (+ (* (iexp it563 5) (+ 0 (- 1)))
                 (* (iexp it561 2) (+ 0 (- 1)))
                 (+ 0 it562))
              (+ 0 0)))
      (a!2 (* (* (iexp 9 (+ it140 (- 1))) (iexp it563 3)) (+ 0 (- 1))))
      (a!3 (* (iexp it561 2) (iexp (iexp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!5 (* (* (iexp 9 (+ it140 (- 1))) (iexp it563 3)) (+ 0 (- 3))))
      (a!6 (* (* (iexp 9 (+ it140 (- 1))) (+ 0 it562)) (+ 0 3))))
(let ((a!4 (+ (* (iexp it563 5) (+ 0 (- 1)))
              a!2
              (* a!3 (+ 0 (- 1)))
              (* (iexp 9 (+ it140 (- 1))) (+ 0 it562))
              (iexp it563 3)))
