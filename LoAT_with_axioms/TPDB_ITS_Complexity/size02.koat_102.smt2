...
(assert (= (+ (* (iexp (- 1) it92) (+ 0 it4) (+ 0 (- 1))) (+ 0 it447))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it5) (iexp (- 1) it92) (+ 0 (- 1))) (+ 0 it448))
   (+ 0 0)))
(assert (= (+ (+ 0 (* it3 it92 (- 6)))
...
(assert (= (+ (* (+ 0 it447) (iexp (- 1) it13) (+ 0 (- 1))) (+ 0 it467))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it448) (iexp (- 1) it13) (+ 0 (- 1))) (+ 0 it468))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it446) (iexp it13 2) (+ 0 12))
      (* (iexp it13 3) (+ 0 (- 8)))
      (* (iexp it13 2) (+ 0 6))
      (+ 0 (* it469 3))
      (+ 0 (* it446 it13 (- 6)))
      (* (iexp it446 2) (+ 0 it13) (+ 0 (- 6)))
      (+ 0 (* it13 (- 1)))
      (+ 0 (* it449 (- 3))))
   (+ 0 0)))
(check-sat)
