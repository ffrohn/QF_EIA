...
(assert (let ((a!1 (* (iexp it238 2) (iexp (iexp 4 (+ it109 (- 1))) (+ 0 2))))
      (a!2 (* (* (+ 0 it239) (iexp 9 (+ it109 (- 1)))) (+ 0 3)))
      (a!3 (* (* (iexp 9 (+ it109 (- 1))) (iexp it240 3)) (+ 0 (- 3))))
      (a!5 (* (* (iexp 9 (+ it109 (- 1))) (iexp it240 3)) (+ 0 (- 1))))
      (a!7 (> (+ (* (iexp it240 5) (+ 0 (- 1)))
                 (+ 0 it239)
                 (* (iexp it238 2) (+ 0 (- 1))))
              (+ 0 0))))
(let ((a!4 (> (+ (* (iexp it240 5) (+ 0 (- 1)))
                 (* a!1 (+ 0 (- 4)))
                 a!2
                 (iexp it240 3)
                 a!3)
              (+ 0 0)))
      (a!6 (+ (* (iexp it240 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              (* (+ 0 it239) (iexp 9 (+ it109 (- 1))))
              (iexp it240 3)
              a!5)))
  (and a!4
       (> a!6 (+ 0 0))
