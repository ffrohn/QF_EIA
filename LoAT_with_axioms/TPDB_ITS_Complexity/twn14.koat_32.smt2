...
(assert (let ((a!1 (> (+ (+ 0 it545)
                 ...
                 (* (iexp it544 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (iexp (iexp 4 (+ it109 (- 1))) (+ 0 2)) (iexp it544 2)))
      (a!3 (* (* (iexp it546 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 3))))
      (a!4 (* (* (+ 0 it545) (iexp 9 (+ it109 (- 1)))) (+ 0 3)))
      (a!6 (* (* (iexp it546 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ (* a!2 (+ 0 (- 4)))
                 (iexp it546 3)
                 a!3
                 (* (iexp it546 5) (+ 0 (- 1)))
