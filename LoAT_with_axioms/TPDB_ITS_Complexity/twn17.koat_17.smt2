...
(assert (let ((a!1 (* (iexp it511 2) (iexp (iexp 4 (+ it66 (- 1))) (+ 0 2))))
      (a!2 (* (* (iexp it513 3) (iexp 9 (+ it66 (- 1)))) (+ 0 (- 1))))
      (a!4 (* (* (iexp 9 (+ it66 (- 1))) (+ 0 it512)) (+ 0 3)))
      (a!5 (* (* (iexp it513 3) (iexp 9 (+ it66 (- 1)))) (+ 0 (- 3))))
      (a!7 (> (+ (* (iexp it513 5) (+ 0 (- 1)))
                 (* (iexp it511 2) (+ 0 (- 1)))
                 (+ 0 it512))
              (+ 0 0))))
(let ((a!3 (+ (* (iexp it513 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              (iexp it513 3)
              (* (iexp 9 (+ it66 (- 1))) (+ 0 it512))
              a!2))
