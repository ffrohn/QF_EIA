...
(assert (let ((a!1 (* (iexp (iexp 4 (+ it140 (- 1))) (+ 0 2)) (iexp it552 2)))
      (a!2 (* (* (iexp 9 (+ it140 (- 1))) (iexp it554 3)) (+ 0 (- 3))))
      (a!3 (* (* (iexp 9 (+ it140 (- 1))) (+ 0 it553)) (+ 0 3)))
      (a!5 (> (+ (+ 0 it553)
                 (* (iexp it554 5) (+ 0 (- 1)))
                 (* (iexp it552 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (* (* (iexp 9 (+ it140 (- 1))) (iexp it554 3)) (+ 0 (- 1)))))
(let ((a!4 (> (+ (* a!1 (+ 0 (- 4)))
                 a!2
                 (* (iexp it554 5) (+ 0 (- 1)))
                 a!3
