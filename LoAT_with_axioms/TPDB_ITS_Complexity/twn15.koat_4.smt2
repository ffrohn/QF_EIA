...
(assert (let ((a!1 (* (* (iexp it136 3) (iexp 9 (+ it68 (- 1)))) (+ 0 (- 1))))
      (a!2 (* (iexp (iexp 4 (+ it68 (- 1))) (+ 0 2)) (iexp it134 2)))
      (a!4 (* (* (iexp it136 3) (iexp 9 (+ it68 (- 1)))) (+ 0 (- 3))))
      (a!5 (* (* (iexp 9 (+ it68 (- 1))) (+ 0 it135)) (+ 0 3)))
      (a!7 (> (+ (* (iexp it136 5) (+ 0 (- 1)))
                 (* (iexp it134 2) (+ 0 (- 1)))
                 (+ 0 it135))
              (+ 0 0))))
(let ((a!3 (+ a!1
              (* (iexp it136 5) (+ 0 (- 1)))
              (* (iexp 9 (+ it68 (- 1))) (+ 0 it135))
              (iexp it136 3)
              (* a!2 (+ 0 (- 1)))))
      (a!6 (> (+ a!4
                 (* (iexp it136 5) (+ 0 (- 1)))
