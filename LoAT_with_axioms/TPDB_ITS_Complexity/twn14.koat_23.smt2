...
(assert (let ((a!1 (* (iexp it498 2) (iexp (iexp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!2 (* (* (+ 0 it499) (iexp 9 (+ it140 (- 1)))) (+ 0 3)))
      (a!3 (* (* (iexp 9 (+ it140 (- 1))) (iexp it500 3)) (+ 0 (- 3))))
      (a!5 (* (* (iexp 9 (+ it140 (- 1))) (iexp it500 3)) (+ 0 (- 1))))
      (a!7 (> (+ (+ 0 it499)
                 (* (iexp it498 2) (+ 0 (- 1)))
                 (* (iexp it500 5) (+ 0 (- 1))))
              (+ 0 0))))
