...
(assert (let ((a!1 (* (* (iexp it384 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 1))))
      (a!2 (* (iexp (iexp 4 (+ it109 (- 1))) (+ 0 2)) (iexp it382 2)))
      (a!4 (> (+ (* (iexp it382 2) (+ 0 (- 1)))
                 (+ 0 it383)
                 (* (iexp it384 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (iexp it384 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 3))))
      (a!6 (* (* (+ 0 it383) (iexp 9 (+ it109 (- 1)))) (+ 0 3))))
(let ((a!3 (+ (* (iexp it384 5) (+ 0 (- 1)))
              a!1
              (iexp it384 3)
              (* (+ 0 it383) (iexp 9 (+ it109 (- 1))))
              (* a!2 (+ 0 (- 1)))))
      (a!7 (> (+ (* (iexp it384 5) (+ 0 (- 1)))
                 a!5
                 (iexp it384 3)
                 a!6
                 (* a!2 (+ 0 (- 4))))
