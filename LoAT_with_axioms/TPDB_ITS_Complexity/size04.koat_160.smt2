...
(assert (= (+ (* (iexp (- 1) it740) (+ 0 it735) (+ 0 (- 1))) (+ 0 it783))
   (+ 0 0)))
(assert (= (+ (+ 0 it784) (* (+ 0 it736) (iexp (- 1) it740) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (iexp it740 3) (+ 0 (- 8)))
      (* (iexp it740 2) (+ 0 6))
      (* (+ 0 it740) (iexp it734 2) (+ 0 (- 6)))
      (+ 0 (* it740 it734 (- 6)))
      (+ 0 (* it740 (- 1)))
      (+ 0 (* it737 (- 3)))
      (* (iexp it740 2) (+ 0 it734) (+ 0 12))
      (+ 0 (* it785 3)))
   (+ 0 0)))
