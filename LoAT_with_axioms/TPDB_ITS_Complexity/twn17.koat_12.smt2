...
(assert (let ((a!1 (* (* (iexp 9 (+ it200 (- 1))) (iexp it527 3)) (+ 0 (- 3))))
      (a!2 (* (iexp it525 2) (iexp (iexp 4 (+ it200 (- 1))) (+ 0 2))))
      (a!3 (* (* (+ 0 it526) (iexp 9 (+ it200 (- 1)))) (+ 0 3)))
      (a!5 (* (* (iexp 9 (+ it200 (- 1))) (iexp it527 3)) (+ 0 (- 1))))
      (a!7 (> (+ (* (iexp it525 2) (+ 0 (- 1)))
                 (+ 0 it526)
                 (* (iexp it527 5) (+ 0 (- 1))))
              (+ 0 0))))
(let ((a!4 (> (+ (* (iexp it527 5) (+ 0 (- 1)))
                 a!1
                 (* a!2 (+ 0 (- 4)))
                 (iexp it527 3)
                 a!3)
              (+ 0 0)))
      (a!6 (+ (* (iexp it527 5) (+ 0 (- 1)))
              a!5
              (* a!2 (+ 0 (- 1)))
              (iexp it527 3)
              (* (+ 0 it526) (iexp 9 (+ it200 (- 1)))))))
  (and (> (* it525 (- 2)) 0)
       a!4
       (> a!6 (+ 0 0))
       (>= (+ (* it522 (- 1)) 3) 0)
