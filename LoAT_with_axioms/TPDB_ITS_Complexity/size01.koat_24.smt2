...
(assert (= (+ (+ 0 it135) (* (iexp (- 1) it84) (+ 0 it79) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it80) (iexp (- 1) it84) (+ 0 (- 1))) (+ 0 it136))
   (+ 0 0)))
(assert (= (+ (* (iexp it84 2) (+ 0 it78) (+ 0 12))
      (* (iexp it84 3) (+ 0 (- 8)))
      (+ 0 (* it84 (- 1)))
      (+ 0 (* it81 (- 3)))
      (* (iexp it84 2) (+ 0 6))
      (* (+ 0 it84) (iexp it78 2) (+ 0 (- 6)))
      (+ 0 (* it84 it78 (- 6)))
      (+ 0 (* it137 3)))
   (+ 0 0)))
...
(assert (= (+ (+ 0 it168) (* (+ 0 it135) (iexp (- 1) it83) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (iexp (- 1) it83) (+ 0 it136) (+ 0 (- 1))) (+ 0 it169))
   (+ 0 0)))
(assert (let ((a!1 (+ (+ 0 (+ (* it170 3) (* it83 (- 1))))
              (* (iexp it83 2) (+ 0 it134) (+ 0 12))
              (+ 0 (* it83 it134 (- 6)))
              (* (iexp it83 2) (+ 0 6))
              (+ 0 (* it137 (- 3)))
              (* (iexp it83 3) (+ 0 (- 8)))
              (* (+ 0 it83) (iexp it134 2) (+ 0 (- 6))))))
  (= a!1 (+ 0 0))))
