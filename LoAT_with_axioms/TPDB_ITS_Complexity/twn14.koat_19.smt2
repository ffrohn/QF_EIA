...
(assert (let ((a!1 (* (iexp it360 2) (iexp (iexp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!2 (* (* (+ 0 it361) (iexp 9 (+ it140 (- 1)))) (+ 0 3)))
      (a!3 (* (* (iexp 9 (+ it140 (- 1))) (iexp it362 3)) (+ 0 (- 3))))
      (a!5 (> (+ (+ 0 it361)
                 (* (iexp it360 2) (+ 0 (- 1)))
                 (* (iexp it362 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (* (* (iexp 9 (+ it140 (- 1))) (iexp it362 3)) (+ 0 (- 1)))))
(let ((a!4 (> (+ (iexp it362 3)
                 (* a!1 (+ 0 (- 4)))
                 (* (iexp it362 5) (+ 0 (- 1)))
                 a!2
                 a!3)
