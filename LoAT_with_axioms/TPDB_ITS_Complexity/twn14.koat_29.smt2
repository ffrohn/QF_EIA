...
(assert (let ((a!1 (* (iexp (iexp 4 (+ it109 (- 1))) (+ 0 2)) (iexp it576 2)))
      (a!2 (* (* (iexp it578 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 1))))
      (a!4 (> (+ (* (iexp it578 5) (+ 0 (- 1)))
                 (* (iexp it576 2) (+ 0 (- 1)))
                 (+ 0 it577))
              (+ 0 0)))
      (a!5 (* (* (iexp 9 (+ it109 (- 1))) (+ 0 it577)) (+ 0 3)))
      (a!6 (* (* (iexp it578 3) (iexp 9 (+ it109 (- 1)))) (+ 0 (- 3)))))
(let ((a!3 (+ (* (iexp 9 (+ it109 (- 1))) (+ 0 it577))
              (* (iexp it578 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              (iexp it578 3)
              a!2))
