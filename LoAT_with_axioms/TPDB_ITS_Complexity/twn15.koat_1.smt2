...
(assert (= (+ it97 (* it6 (- 1))) 0))
(assert (= (+ it98 (* it7 (- 1))) 0))
(assert (let ((a!1 (* (* (iexp 9 (+ it68 (- 1))) (iexp it97 3)) (+ 0 (- 1))))
      (a!2 (* (iexp it95 2) (iexp (iexp 4 (+ it68 (- 1))) (+ 0 2))))
      (a!4 (> (+ (* (iexp it97 5) (+ 0 (- 1)))
                 (+ 0 it96)
                 (* (iexp it95 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (iexp 9 (+ it68 (- 1))) (iexp it97 3)) (+ 0 (- 3))))
      (a!6 (* (* (+ 0 it96) (iexp 9 (+ it68 (- 1)))) (+ 0 3))))
(let ((a!3 (+ a!1
              (* a!2 (+ 0 (- 1)))
              (* (iexp it97 5) (+ 0 (- 1)))
              (* (+ 0 it96) (iexp 9 (+ it68 (- 1))))
              (iexp it97 3)))
      (a!7 (> (+ a!5
                 (* a!2 (+ 0 (- 4)))
                 (* (iexp it97 5) (+ 0 (- 1)))
