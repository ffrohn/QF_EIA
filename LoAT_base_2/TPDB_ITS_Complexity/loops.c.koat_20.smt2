...
(assert (= (+ it74 (- 1)) 0))
(assert (let ((a!1 (+ (* (int.pow2 (+ it80 (- 1))) (+ 0 it74) (+ 0 (- 1)))
              (+ 0 it73))))
  (and (> (+ it73 (* it74 (- 1))) 0)
       (> a!1 (+ 0 0))
       (>= (+ it70 (- 9)) 0)
...
(assert (= (+ (+ 0 it86) (* (int.pow2 it80) (+ 0 it74) (+ 0 (- 1)))) (+ 0 0)))
...
(assert (= (+ it113 (- 1)) 0))
(assert (let ((a!1 (+ (* (+ 0 it113) (int.pow2 (+ it87 (- 1))) (+ 0 (- 1)))
              (+ 0 it112))))
  (and (>= (+ (* it109 (- 1)) 9) 0)
       (> a!1 (+ 0 0))
       (>= (+ it87 (- 1)) 0)
...
(assert (= (+ (* (+ 0 it113) (int.pow2 it87) (+ 0 (- 1))) (+ 0 it124))
   (+ 0 0)))
