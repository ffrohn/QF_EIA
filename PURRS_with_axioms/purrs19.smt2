...
(assert (> n 1))
(assert (distinct
  (+ (* x0 (- (* 3 (iexp 2 n)) (* 2 (iexp 3 n)))) (* x1 (- (iexp 3 n) (iexp 2 n))) (* 2 (iexp 3 n)) (- (* 4 (iexp 2 n))) 2)
  (+ (* 5
    (+ (* x0 (- (* 3 (iexp 2 (- n 1))) (* 2 (iexp 3 (- n 1))))) (* x1 (- (iexp 3 (- n 1)) (iexp 2 (- n 1)))) (* 2 (iexp 3 (- n 1))) (- (* 4 (iexp 2 (- n 1)))) 2)
  ) (- (* 6
    (+ (* x0 (- (* 3 (iexp 2 (- n 2))) (* 2 (iexp 3 (- n 2))))) (* x1 (- (iexp 3 (- n 2)) (iexp 2 (- n 2)))) (* 2 (iexp 3 (- n 2))) (- (* 4 (iexp 2 (- n 2)))) 2)
  )) 4)
))
